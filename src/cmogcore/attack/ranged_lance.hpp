...
class LanceAttack {
 ...
 public:
  ...
  static constexpr Magic get_magic() {
    ...
    switch (Owner * 10 + Base::rank) {
      ...
      case 3:
        ...
        // ---------      ---------
        //
        return {1ULL, 0, 0ULL, 0, Base::file + 8};
        break;
      case 4:
      case 5:
      case 6:
      case 7:
        ...
        //                        a
        //
        return {m1, 0, 0ULL, 0, 66 - Base::rank};
        break;
      case 8:
        ...
        // ---------                                    ---------
        //
        return {m1, 58, 1ULL, Base::file - 1, 0};
        break;
      case 9:
        ...
        //                        -              a              -
        //
        return {m1, 0, 0x0401000000000000ULL >> (Base::file - 1), 0, 57, 0ULL};
        break;
      // white lance
      case 11:
      case 12:
      ...
      case 14:
        ...
        //                        a              a
        //
        return {0x0001010101010000ULL >> (Base::file - 1), 0, m2, 0, Base::rank + 56, 0ULL};
        break;
      case 15:
        ...
        //                        a
        //
        return {1ULL, Base::file + 44, m2, 61, 0, 0ULL};
        break;
      case 16:
        // High multiply only
        //
      ...
      case 17:
        ...
        // ---------  =>  ---------
        //
        return {0ULL, 0, 1ULL, 0, Base::file + 8, 0ULL};
        break;
      default:
        //
        // Fixed
  ...
  static constexpr auto make_table() { return util::array::iterate<Base::variation_size>(&__make_attack); }
  ...
  static std::vector<BitBoard> get_variation() {
    ...
    for (auto x: make_table()) v.push_back(x);
    return std::move(v);
  } 
#endif
...
struct LanceAttackGenerator {
  template <int... Is>
  static constexpr auto generate(util::seq<Is...>) -> util::Array<decltype(&LanceAttack<Owner, 0>::get_attack), sizeof...(Is)> {
 ...
 */
template <bool Owner>
struct LanceAttackTableGenerator {
  template <int... Is>
  static constexpr auto generate(util::seq<Is...>) -> util::Array<decltype(&LanceAttack<Owner, 0>::get_variation), sizeof...(Is)> {
    return {{&LanceAttack<Owner, Is>::get_variation...}};
  }
