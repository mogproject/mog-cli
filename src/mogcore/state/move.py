...
class Move(cmogcore.Move):
    ...
    def __init__(self, turn: Turn, from_: Pos, to: Pos, piece_type: PieceType):
        ...
        cmogcore.Move.__init__(self, turn.value, from_.value, to.value, piece_type.value)
        self.turn = turn
        self.from_ = from_
        self.to = to
    ...
    def __repr__(self):
        return 'Move(turn=%r, from_=%r, to=%r, piece_type=%r)' % (self.turn, self.from_, self.to, self.piece_type)
